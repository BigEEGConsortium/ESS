classdef essManager
    ...
    properties
        ...
        sessionInfo = struct;
        tasksInfo = struct;
        eventCodesInfo = struct;
        summaryInfo = struct;
        publicationsInfo = struct;
        experimentersInfo = struct;
        contactInfo = struct;
    ...
    methods
        ...
        function obj = read(obj, essFilePath)
           ...
           % Reads the information contained an ESS-formatted XML file and placed it into object properties.
            ...
            if potentialTitleNodeArray.getLength > 0
            ...
            if potentialProjectNodeArray.getLength > 0
            ...
            if potentialTasksNodeArray.getLength > 0
            ...
            if potentialCopyrightNodeArray.getLength > 1
                obj.copyrightInfo = strtrim(char(potentialCopyrightNodeArray.item(0).getFirstChild.getData));
            else
                obj.copyrightInfo = '';
            ...
            if potentialIRBNodeArray.getLength > 0
                obj.irbInfo = strtrim(char(potentialIRBNodeArray.item(0).getFirstChild.getData));
            else
                obj.irbInfo = '';
            end;
