...
%                  (thanks to Isabel P)
%   4.1 (jan 2015) modified to allow empty inputs (Spencer Kellis; email
%                  spencer.kellis@caltech.edu).

narginchk(1,Inf); % updated to satisfy R2014 warning about nargck
% ** BEGIN MODIFICATION HERE **
% N = nargin ; % superceded by following modifications

% if any one input is empty, remove it from varargin
...
% return immediately if no inputs left
if N==0
    A=[];
    return;
end
