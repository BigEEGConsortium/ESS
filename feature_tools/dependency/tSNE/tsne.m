function ydata = tsne(X, labels, no_dims, initial_dims, perplexity, pairwiseDistance)
%TSNE Performs symmetric t-SNE on dataset X
% (pairwiseDistance added by Nima, if provided will ignore X)
%
%   mappedX = tsne(X, labels, no_dims, initial_dims, perplexity, pairwiseDistance)
