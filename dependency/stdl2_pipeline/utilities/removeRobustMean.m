function [EEG, robustMean, referenceChannels] = removeRobustMean(EEG, referenceChannels, iterations)
...
if nargin < 1 || ~isstruct(EEG)
    error('removeRobustMean:NotEnoughArguments', ...
...
EEG.data(referenceChannels, :) = ...
        bsxfun(@minus, EEG.data(referenceChannels, :), robustMean);
